...
class VolcArkProvider(LLMProvider):
    ...
    def _build_payload(self, state_summary: Dict, k: int, repair_raw: Optional[str] = None) -> Dict:
        system_prompt = (
            ...
            "- When macro candidates exist, pick AT MOST ONE macro candidate in your pick list.\n"
            "- If any candidate has type \"direction\" (or id in [900101,900102]), you MUST include exactly ONE direction candidate in your pick list.\n"
            "- When direction candidates (900101/900102) exist, pick EXACTLY ONE direction.\n"
            ...
            "- Avoid choosing only candidates with the smallest d_total; include macro and direction constraints above when present.\n"
        )
