...
def main():
    # 你给的数据（2080ti）
    csv_ms_mem = "./proxy_retrain/layer_dataset_2080ti.csv"  # 字段包含ms、peak_mem_mb
    csv_power = "./proxy_retrain/layer_power_dataset_2080ti.csv"  # 字段包含ms_event、energy_mj、avg_power_w

    out_dir = "./proxy_ckpts_2080ti"
